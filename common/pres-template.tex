...
%% TODO: use proper color names

$if(darkmode)$
\usepackage[mocha]{catppuccinpalette}
%% Dark
\colorlet{bgmain}{CtpBase}
\colorlet{bginverted}{CtpSurface0}
\colorlet{main}{CtpText}
\colorlet{maininverted}{CtpText}
$else$
\usepackage[latte]{catppuccinpalette}
%% Light
\colorlet{bgmain}{white}
