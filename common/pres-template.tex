...
% set color scheme for dark/light modes
$if(beamer)$
$if(darkmode)$
\colorlet{main}{maindark}
\colorlet{maininverted}{maininverteddark}
\colorlet{bgmain}{bgmaindark}
\colorlet{bginverted}{bginverteddark}
$else$
\colorlet{main}{mainlight}
\colorlet{maininverted}{maininvertedlight}
\colorlet{bgmain}{bgmainlight}
\colorlet{bginverted}{bginvertedlight}
$endif$
$endif$
