...
%% TOOD: setup proper catppuccin color palette

%% Dark
\definecolor{bgmaindark}{HTML}{1E1E2E}
\definecolor{bginverteddark}{HTML}{43465A}
\definecolor{maindark}{HTML}{C6D0F5}
\colorlet{maininverteddark}{maindark}

%% Light
\colorlet{bgmainlight}{white}
\definecolor{bginvertedlight}{RGB}{98,98,98}
\colorlet{mainlight}{black}
\colorlet{maininvertedlight}{white}
