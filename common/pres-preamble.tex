...
\lstdefinestyle{dot}{
  style=default,
  morekeywords={digraph},
}

\lstdefinestyle{latex}{
  style=default,
  morekeywords={begin,end,documentclass},
}
...
%% Pandoc wraps captionless beamer tables in {\def\LTcaptype{none} ...}
%% and modern longtable steps \LTcaptype at table start, so define the
%% "none" counter it references.
\newcounter{none}
