...
- Текстовый формат
  - Версионируется VCS
  - Открывается любимым редактором
  - Легко ревьювится
...
- Стандартизация структуры и оформления
...
- Нестандартное оформление требует *значительных* усилий
- Трудно совмещается с WYSIWYG шаблонами
